 ...
 */
export declare type NonNull<T> = Exclude<T, null>;
/**
 ...
 */
export declare type NonNil<T> = Exclude<T, nil>;
/**
 * Utility type that modifies an object type to allow `undefined` on all properties.
 */
export declare type WithUndefinedProperties<T extends {}> = {
 ...
 */
export declare type ExtractReactPropsType<T> = T extends React.ComponentType<
    infer P
>
    ? P
 ...
 */
export declare enum ListManagerApiEnv {
    /**
     * The production API environment.
     */
 ...
 */
export declare enum PayloadApiEnv {
    /**
     * The production API environment.
     */
